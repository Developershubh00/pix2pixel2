          ...
          >
            ...
            <div className="mt-6 md:mt-8">
              ...
              <div className="flex space-x-4">
                <a href=" https://www.facebook.com/share/16ghxEQp24/" className="text-gray-600 hover:text-[#00BCD4] transition-colors">
                  <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                    <path d="M18 2h-3a5 5 0 0 0-5 5v3H7v4h3v8h4v-8h3l1-4h-4V7a1 1 0 0 1 1-1h3z"></path>
                  </svg>
                </a>
                <a href="https://www.instagram.com/pix2pixel?igsh=bGppZ2loY2Vja2Y3" className="text-gray-600 hover:text-[#00BCD4] transition-colors">
                  <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                ...
                <a href="https://www.linkedin.com/company/pix2pixel/" className="text-gray-600 hover:text-[#00BCD4] transition-colors">
                  <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
